"""New pipeline using the 4-layer SOTA architecture"""
...
class Paper2ChunkSOTAPipeline:
    """New pipeline using SOTA 4-layer architecture:
    ...
    def process(self, pdf_path: str) -> Document:
        """Process a PDF file through the SOTA 4-layer pipeline
        ...
        """
        print(f"\n{'='*60}")
        print(f"Processing PDF with SOTA 4-Layer Architecture")
        print(f"{'='*60}\n")
